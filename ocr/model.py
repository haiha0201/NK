...
class Model:
    def __init__(self,
        ...
        textdet_models = yaml.safe_load(open('assets/textdet_models.yaml', 'r'))
        textrecog_models = yaml.safe_load(open('assets/textrecog_models.yaml', 'r'))
        kie_models = yaml.safe_load(open('assets/kie_models.yaml', 'r'))
        ...
        if self.td and self.td == 'Tesseract':
            ...
            raise Exception('Cannot create detect_model')
        ...
        if self.tr and self.tr == 'Tesseract':
            ...
            raise Exception('Cannot create recog_model')
    ...
    def readtext(self,
        ...
        if self.detect_model and self.recog_model:
            ...
            raise Exception('Invalid detect_model and recog_model')
            for model in list(
